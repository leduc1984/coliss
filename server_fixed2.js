...
const startServer = async () => {
  try {
    ...
    server.listen(PORT, () => {
      ...
      // Using a different approach to write this log line to try to fix the issue
      const editorUrl = `http://localhost:${PORT}/pokemon-map-editor/`;
      console.log('🗺️  Map editor at: ' + editorUrl);
    });
  } catch (error) {
